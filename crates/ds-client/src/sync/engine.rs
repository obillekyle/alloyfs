...
use ds_proto::{ErrorCode, EventKind, FsEvent, RelPath, Request, Response};
...
impl SyncEngine {
    ...
    async fn pull_if_needed(&self, rel: &str) -> Result<(), FsError> {
        ...
        if attr.kind == ds_proto::FileKind::Dir {
