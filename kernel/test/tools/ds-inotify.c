...
/*
 * ds-inotify — a minimal, exact inotify probe for the ds-fs test harness.
 *
 ...
 *
 * Build: gcc -static -Os -o ds-inotify ds-inotify.c
 */
#include <errno.h>
#include <limits.h>
#include <poll.h>
...
int main(int argc, char **argv)
{
	...
	/* usage: ds-inotify [-t SECONDS] PATH... */
	i = 1;
	...
	if (i >= argc) {
		fprintf(stderr, "usage: ds-inotify [-t SECONDS] PATH...\n");
		return 1;
	}
